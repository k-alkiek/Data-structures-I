package eg.edu.alexu.csd.datastructure.maze.cs22;
...
import eg.edu.alexu.csd.datastructure.queue.cs22.MyQueueLinked;
import eg.edu.alexu.csd.datastructure.stack.cs22.MyStack;
...
public class MyMazeSolver implements IMazeSolver{
	/**
	 * A string array holding data of the maze.
	 * Cell (x,y) is represented as the yth character
	 * in the xth string.
	 */
	...
	/**
	 * Boolean array for the state of each cell.
	 */
	private boolean[][] visited;
	
	/**
	 * A map to save the previous cell of a given cell
	 * used in tracing the path of the maze at the end.
	 */
	private HashMap<Point, Point> path;
	
	/**
	 * Number of cells to check around a cell.
	 */
